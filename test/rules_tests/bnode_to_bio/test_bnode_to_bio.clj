...
(def cl-triples '(
                   ...
                   (obo/CL_0002590 oboInOwl/hasOBONamespace ["cell" xsd/string])
                   ...
                   (obo/CL_0000359 oboInOwl/hasOBONamespace ["cell" xsd/string])
                   ...
                   (obo/UBERON_0002049 oboInOwl/hasOBONamespace ["uberon" xsd/string])
                   ...
                   (obo/UBERON_0000955 oboInOwl/hasOBONamespace ["uberon" xsd/string])
...
(deftest test-step-ab
  (let [source-kb (test-kb input-triples)
    ...
    (is (ask target-kb '((kice/UBERON_0002049 obo/IAO_0000219 obo/UBERON_0002049)
                          ...
                          (kice/UBERON_0002049 rdfs/subClassOf ccp/IAO_EXT_0000307))))
    ...
    (is (ask target-kb '((kice/UBERON_0000955 obo/IAO_0000219 obo/UBERON_0000955)
                          ...
                          (kice/UBERON_0000955 rdfs/subClassOf ccp/IAO_EXT_0000307))))
...
(deftest test-step-c
  (let [source-kb (test-kb input-triples)
    ...
    (is (ask target-kb '((?/ds rdf/type ccp/IAO_EXT_0000012)
                          (?/ds obo/IAO_0000142 ?/d)
                          (?/d rdfs/label ["http://www.reactome.org/pages/download-data/biopax/Homo_sapiens.owl" "en"])
                          (?/ds rdfs/label ["Reactome BioPAX record set, Homo sapiens" "en"]))))

    (is (ask target-kb '((kice/NCBI_GI_555853 skos/exactMatch kice/GENBANK_U13369)
                          (kice/NCBI_GI_555853 rdfs/subClassOf ccp/IAO_EXT_0000262))))
    ...
    ;  (run-build-rule source-kb log-kb build-rules-step-ca 1)
    ;  (run-build-rule source-kb log-kb build-rules-step-ca 2)
    ;  (run-build-rule source-kb log-kb build-rules-step-ca 3)
    ;  (run-build-rule source-kb log-kb build-rules-step-ca 4)
    ...
    ;  (run-build-rule source-kb log-kb build-rules-step-cd 0)
    ;  (close log-kb))
...
(deftest test-step-d
  (let [source-kb (test-kb input-triples)
    ...
    (is (ask target-kb '((kice/NCBI_GI_555853 rdfs/subClassOf ccp/IAO_EXT_0000342))))
    ...
    ;  (run-build-rule source-kb log-kb build-rules-step-da 6)
    ;  (run-build-rule source-kb log-kb build-rules-step-da 7)
    ...
    ;  (run-build-rule source-kb log-kb build-rules-step-db 8)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 9)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 10)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 11)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 12)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 13)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 14)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 15)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 16)
    ;  (run-build-rule source-kb log-kb build-rules-step-db 17)
