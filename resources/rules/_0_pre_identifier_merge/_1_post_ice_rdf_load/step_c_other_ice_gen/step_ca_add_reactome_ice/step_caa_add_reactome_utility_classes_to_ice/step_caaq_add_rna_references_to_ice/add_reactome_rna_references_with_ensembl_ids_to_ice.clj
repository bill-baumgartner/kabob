`{:description "This rule finds any rna reference record described in Reactome with an ENSEMBL ID.",
 :name "add_reactome_rna_references_with_ensembl_ids_to_ice",
 :reify ([?/rna_ref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome rna reference record" ?/rna_ref), :prefix "R_"}]
  ...
  :body "#add_reactome_rna_references_with_ensembl_ids_to_ice.clj
...
SELECT DISTINCT ?rna_ref ?xref_record ?xref_id_field ?ensembl_ice WHERE {
