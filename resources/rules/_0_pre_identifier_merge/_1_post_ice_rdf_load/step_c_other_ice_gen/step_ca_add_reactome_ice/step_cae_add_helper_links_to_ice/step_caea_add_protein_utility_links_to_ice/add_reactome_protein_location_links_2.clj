`{:description "Auxiliary rule to link protein ids and GO-CC locations.",
 :name "add_reactome_protein_location_links_2",
 :head ((?/reactome_id_field ccp/ekws_temp_loc_connector_relation ?/go_cc_id_field)
        ),
 :body "#add_reactome_protein_location_links_2
...
?protein_record obo:BFO_0000051 ?this_cell_loc_record .
