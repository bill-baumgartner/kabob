`{:description "Auxiliary rule to connect physical entity reactome ids and GO-CC locations directly.",
 :name "add_reactome_physical_entity_location_links_2",
 :head ((?/reactome_id_field ccp/ekws_temp_loc_connector_relation ?/go_cc_id_field)
        ),
 :body "#add_reactome_physical_entity_location_links_2
...
SELECT DISTINCT ?reactome_id_field ?go_cc_id_field
WHERE {
?physical_entity_record rdf:type ccp:IAO_EXT_0001515 .  # physical entity record

?physical_entity_record obo:BFO_0000051 ?this_xref_record .
...
?physical_entity_record obo:BFO_0000051 ?this_cell_loc_record .
