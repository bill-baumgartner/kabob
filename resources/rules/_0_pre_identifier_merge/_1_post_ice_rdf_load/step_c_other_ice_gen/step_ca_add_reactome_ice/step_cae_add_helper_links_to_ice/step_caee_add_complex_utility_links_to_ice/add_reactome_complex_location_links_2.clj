`{:description "Auxiliary rule to connect complex reactome ids and GO-CC locations directly.",
 :name "add_reactome_complex_location_links_2",
 :head ((?/reactome_id_field ccp/ekws_temp_loc_connector_relation ?/go_cc_id_field)
        ),
 :body "#add_reactome_complex_location_links_2
...
?complex_record obo:BFO_0000051 ?this_xref_record .
...
?complex_record obo:BFO_0000051 ?this_cell_loc_record .
