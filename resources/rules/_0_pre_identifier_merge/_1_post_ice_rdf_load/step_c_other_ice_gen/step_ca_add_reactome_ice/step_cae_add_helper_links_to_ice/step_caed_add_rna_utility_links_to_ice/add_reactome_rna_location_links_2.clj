`{:description "Auxiliary rule to connect rna reactome ids and GO-CC locations directly.",
 :name "add_reactome_rna_location_links_2",
 :head ((?/reactome_id_field ccp/ekws_temp_loc_connector_relation ?/go_cc_id_field)
        ),
 :body "#add_reactome_rna_location_links_2
...
?rna_record obo:BFO_0000051 ?this_cell_loc_record .
