`{:description "Auxiliary rule to connect dna reactome ids and GO-CC locations directly.",
 :name "add_reactome_dna_location_links_2",
 :head ((?/reactome_id_field ccp/ekws_temp_loc_connector_relation ?/go_cc_id_field)
        ),
 :body "#add_reactome_dna_location_links_2
...
?dna_record obo:BFO_0000051 ?this_cell_loc_record .
