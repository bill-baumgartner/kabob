`{:description "This rule finds any physical entity record described in Reactome, as well as its Reactome id field.",
 ...
 :reify ([?/phent_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome physical entity record" ?/phent), :prefix "R_"}]
         [?/this_xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 ?/xref_record ?/phent_record), :prefix "R_"}]
         [?/reactome_ice]
         ),
 :head ((?/record_set obo/BFO_0000051 ?/phent_record)
        (?/phent_record rdf/type ccp/IAO_EXT_0001515) ;; physical entity record
        (?/phent_record obo/BFO_0000051 ?/this_xref_record)
...
SELECT DISTINCT ?record_set ?phent ?xref_record ?xref_id_field ?reactome_ice WHERE {
