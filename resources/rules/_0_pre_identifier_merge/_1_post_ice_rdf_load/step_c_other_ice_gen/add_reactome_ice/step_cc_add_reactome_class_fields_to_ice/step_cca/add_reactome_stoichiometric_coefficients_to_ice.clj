`{:description "This rule finds any stoichiometric coefficient field described in Reactome, for either complex or biochemical reaction stoichiometries.",
 :name "step_cca-add_reactome_stoichiometric_coefficients_to_ice",
...
SELECT DISTINCT ?reactome_thing_record ?stoichiometric_coefficient WHERE {
