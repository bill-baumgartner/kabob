`{:description "This rule finds any EC number field described for a biochemical reaction in Reactome.",
 :name "step_cca-add_reactome_ec_numbers_to_ice",
...
SELECT DISTINCT ?reactome_thing_record ?ec_number WHERE {
