`{:description "This rule finds any rna reference record described in Reactome with an existing EMBL ID.",
 :name "step_cab-add_reactome_rna_references_with_existing_embl_ids_to_ice",
...
# Although these identifiers are labeled as EMBL, they in fact appear to be European Nucleotide Archive (ENA) identifiers
bind (uri (concat (str (\"http://ccp.ucdenver.edu/kabob/ice/ENA_\"), str (?embl_id))) as ?embl_ice) .
