`{:description "This rule finds any sequence modification vocabulary (wrt PSI-MOD) record described in Reactome with an xref.",
 :name "step_cab-add_reactome_sequence_modification_vocabularies_to_ice",
  :reify ([?/sm_vocab_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome sequence modification vocabulary record" ?/seq_mod_vocab), :prefix "R_"}]
          ...
          [?/this_sm_vocab_xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 ?/sm_vocab_xref_record ?/sm_vocab_record), :prefix "R_"}]
          ),
  :head ((?/sm_vocab_record rdf/type ccp/IAO_EXT_0001583) ;; sequence modification vocabulary record
         (?/sm_vocab_record obo/BFO_0000051 ?/this_sm_vocab_xref_record)
         (?/this_sm_vocab_xref_record obo/BFO_0000051 ?/sm_vocab_xref_record)
         (?/this_sm_vocab_xref_record rdf/type ccp/IAO_EXT_0001588) ;; xref field
...
SELECT DISTINCT ?seq_mod_vocab ?sm_vocab_xref_record ?react_term WHERE {
