`{:description "This rule finds any dna reference record described in Reactome with an ENSEMBL ID.",
 :name "step_cab-add_reactome_dna_references_with_ensembl_ids_to_ice",
...
SELECT DISTINCT ?dna_ref ?xref_record ?xref_id_field ?ensembl_ice WHERE {
