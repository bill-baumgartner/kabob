`{:description "This rule finds any biosource record described in Reactome.",
 :name "step_cab-add_reactome_biosources_to_ice",
  :reify ([?/bio_source_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome biosource record" ?/bio_source), :prefix "R_"}]
          [?/this_bio_source_xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 ?/bio_source_xref_record ?/bio_source), :prefix "R_"}]
         ),
  :head ((?/bio_source_record rdf/type ccp/IAO_EXT_0001578) ;; biosource record
         (?/bio_source_record obo/BFO_0000051 ?/this_bio_source_xref_record)
         (?/this_bio_source_xref_record obo/BFO_0000051 ?/bio_source_xref_record)
         (?/this_bio_source_xref_record rdf/type ccp/IAO_EXT_0001588) ;; xref field
...
SELECT DISTINCT ?bio_source ?bio_source_xref_record WHERE {
