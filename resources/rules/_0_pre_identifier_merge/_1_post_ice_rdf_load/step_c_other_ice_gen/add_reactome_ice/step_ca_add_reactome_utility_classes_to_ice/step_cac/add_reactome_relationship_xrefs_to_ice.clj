`{:description "This rule finds any relationship xref record described in Reactome; they depend on the relationship type vocabularies.",
 :name "step_cac-add_reactome_relationship_xrefs_to_ice",
  :reify ([?/xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome relationship type xref" ?/xref), :prefix "R_"}]
          ...
          [?/this_relationship_type_xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 ?/xref ?/relationship_type_xref_record), :prefix "R_"}]
          ),
  :head ((?/xref_record rdf/type ccp/IAO_EXT_0001570) ;; relationship xref
         ...
         (?/xref_record obo/BFO_0000051 ?/this_relationship_type_xref_record)
         (?/this_relationship_type_xref_record rdf/type ccp/IAO_EXT_0001947) ;; relationship type field
         (?/this_relationship_type_xref_record rdfs/subClassOf ?/relationship_type_xref_record) 
...
SELECT DISTINCT ?xref ?react_db ?react_id ?react_relationship_type ?relationship_type_xref_record WHERE {
