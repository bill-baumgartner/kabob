`{:description "This rule finds any pathway record described in Reactome with a GO BP id field.",
 :name "step_cd-add_reactome_pathway_go_bp_ids_to_ice",
 :reify ([?/this_xref_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 ?/xref_record ?/reactome_pw_record), :prefix "R_"}]),
          
  :head ((?/reactome_pw_record obo/BFO_0000051 ?/this_xref_record)
...
SELECT DISTINCT ?reactome_pw_record ?xref_record ?go_bp_ice ?xref_id_field WHERE {
