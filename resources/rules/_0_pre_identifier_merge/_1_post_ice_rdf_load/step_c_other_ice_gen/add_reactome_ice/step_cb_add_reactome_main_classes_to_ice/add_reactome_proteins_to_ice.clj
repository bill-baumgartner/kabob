`{:description "This rule finds any protein record described in Reactome, as well as its Reactome id field.",
 :name "step_cb-add_reactome_proteins_to_ice",
 ...
 :head ((?/record_set obo/BFO_0000051 ?/prot_record)
        ...
        (?/prot_record obo/BFO_0000051 ?/this_xref_record)
...
SELECT DISTINCT ?record_set ?prot ?xref_record ?xref_id_field ?reactome_ice WHERE {
