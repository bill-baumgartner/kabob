  ...
  :body "prefix franzOption_chunkProcessingAllowed: <franz:yes>
         ...
         prefix ccp: <http://ccp.ucdenver.edu/obo/ext/>
                  ...
                  select distinct ?ontology_concept {
                       ...
                       # exclude concepts that are subclass of information content entity (rdfs:subClassOf* obo:IAO_0000030)
                       # these statements have been added by a previous rule to avoid the subClassOf* in this query
                       minus { ?ontology_concept rdf:type ccp:temp_ice_concept }
