`{:description "This rule connects Reactome template reaction regulation inhibition events with a GO-MF binding term to downstream activities."
 :name "add_reactome_template_reaction_regulations_to_bio_1",
 ...
 :body "#add_reactome_template_reaction_regulations_to_bio_1.clj
