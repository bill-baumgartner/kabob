`{:description "This rule connects Reactome control inhibition events with a GO-MF binding term to downstream activities."
 :name "add_reactome_controls_to_bio_1",
 :reify ([?/causally_upstream_of_negative_restriction {:ln (:restriction), :ns "http://ccp.ucdenver.edu/kabob/bio/" :prefix "RS_"}]
 ...
 :head
 ((?/this_binding_event rdfs/subClassOf ?/causally_upstream_of_negative_restriction)
  ...
  (?/causally_upstream_of_negative_restriction rdf/type owl/Restriction)
  (?/causally_upstream_of_negative_restriction owl/someValuesFrom ?/this_catal_activity)
  (?/causally_upstream_of_negative_restriction owl/onProperty ?/causally_upstream_of_negative_bio)),
 :body "#add_reactome_controls_to_bio_1.clj
...
SELECT DISTINCT ?go_binding_bio ?catal_activity_1 ?this_catalyzed_process_1 ?causally_upstream_of_negative_bio ?has_participant_bio ?controller_bio
WHERE {   
...
?control_record rdf:type ccp:IAO_EXT_0001564 .
?control_record obo:BFO_0000051 ?this_controller_record .
...
?control_record obo:BFO_0000051 ?control_type_field.
?control_type_field rdf:type ccp:IAO_EXT_0001568 . 
?control_type_field rdfs:label \"INHIBITION\"@en .
...
?control_record obo:BFO_0000051 ?this_controlled_record .
...
bind (uri (\"http://ccp.ucdenver.edu/kabob/ice/RO_0002305\") AS ?causally_upstream_of_negative_ice) .
?causally_upstream_of_negative_ice obo:IAO_0000219 ?causally_upstream_of_negative_bio .
filter (?causally_upstream_of_negative_bio != obo:RO_0002305) .
