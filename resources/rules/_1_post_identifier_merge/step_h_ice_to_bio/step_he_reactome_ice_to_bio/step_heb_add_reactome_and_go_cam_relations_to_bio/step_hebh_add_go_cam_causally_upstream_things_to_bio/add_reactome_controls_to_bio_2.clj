`{:description "This rule connects Reactome control activation events with a GO-MF binding term to downstream activities."
 :name "add_reactome_controls_to_bio_2",
 ...
 ((?/this_binding_event rdfs/subClassOf ?/causally_upstream_of_positive_restriction)
  ...
  :body "#add_reactome_controls_to_bio_2.clj
