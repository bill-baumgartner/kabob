`{:description "This rule finds any biochemical record described in Reactome with unique inputs and marks those as inputs in the GO-MF that GO-CAM defines as part of the Reactome biochemical reaction."
 :name "add_reactome_biochemical_reaction_inputs_to_bio_1",
 ...
 :body "#add_reactome_biochemical_reaction_inputs_to_bio_1.clj
