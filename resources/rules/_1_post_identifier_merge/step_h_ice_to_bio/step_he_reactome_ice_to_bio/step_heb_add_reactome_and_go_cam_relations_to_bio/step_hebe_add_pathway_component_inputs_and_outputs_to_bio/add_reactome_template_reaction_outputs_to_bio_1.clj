`{:description "This rule finds any template reaction record described in Reactome with unique outputs and marks those as outputs in the GO-MF that GO-CAM defines as part of the Reactome template reaction."
 :name "add_reactome_template_reaction_outputs_to_bio_1",
 ...
 :body "#add_reactome_template_reaction_outputs_to_bio_1.clj
...
?tmplr_record obo:BFO_0000051 ?this_right_thing_record .
...
?react_id_field rdf:type ?tmplr_ice .  
?tmplr_ice obo:IAO_0000219 ?tmplr_bio .
# get the subclassed reaction in an ordered pathway
?this_controlled_process rdfs:subClassOf ?tmplr_bio .  
