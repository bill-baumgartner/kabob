`{:description "This rule finds any template reaction record described in Reactome with a GO BP annotation and puts it on the bio side.",
 :name "add_reactome_template_reactions_to_bio_2",
 :reify ([?/this_tr {:ln (:sha-1 ?/tr_record), :ns "http://ccp.ucdenver.edu/kabob/bio/", :prefix "BP_"}]
         ),
 :head
 ((?/react_ice obo/IAO_0000219 ?/this_tr) 
  (?/this_tr rdfs/subClassOf ?/go_bp)  ;; specific GO-BP
  ),
 :body "#add_reactome_template_reactions_to_bio_2.clj
