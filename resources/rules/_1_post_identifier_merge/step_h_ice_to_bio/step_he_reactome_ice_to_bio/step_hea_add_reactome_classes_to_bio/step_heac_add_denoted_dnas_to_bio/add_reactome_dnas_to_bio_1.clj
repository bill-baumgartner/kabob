`{:description "This rule finds any unmodified dna record described in Reactome.  The rule places the top-level entity on the BIO side as a localized subclass of the BIO entity denoted by the ENSEMBL or NCBI Nucleotide ICE id.",
 :name "add_reactome_dnas_to_bio_1",
 ...
 :body "#add_reactome_dnas_to_bio_1
...
?this_feature_record rdf:type ccp:IAO_EXT_0001527 . # no features allowed
}
