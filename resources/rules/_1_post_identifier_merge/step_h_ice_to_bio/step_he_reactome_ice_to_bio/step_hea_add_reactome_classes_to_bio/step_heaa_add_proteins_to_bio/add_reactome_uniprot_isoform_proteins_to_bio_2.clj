...
WHERE {
?uniprot_id_field rdf:type ccp:IAO_EXT_0001599 .  # Reactome uniprot isoform accession field
?uniprot_id_field rdfs:label ?isoform_accession_label .
...
?reactome_xref_record rdf:type ccp:IAO_EXT_0001572 . # unification xref
...
?modification_record rdf:type ccp:IAO_EXT_0001586 .  # sequence modification feature fields not allowed
} 
