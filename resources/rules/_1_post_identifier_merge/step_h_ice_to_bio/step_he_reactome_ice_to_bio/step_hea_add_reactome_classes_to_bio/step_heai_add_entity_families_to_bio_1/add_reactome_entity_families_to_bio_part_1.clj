`{:description "This rule finds any functional family described in Reactome and places the top-level entity list on the BIO side.  It lays the groundwork for building these into RDF lists, but they are connected programmatically in part 2.",
...
?member_record obo:BFO_0000051 ?this_member_xref_record .
?this_member_xref_record rdfs:subClassOf ?member_xref_record .
?member_xref_record rdf:type ccp:IAO_EXT_0001572 . # unification xref
