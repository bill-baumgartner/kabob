`{:description "This rule finds any complex record described in Reactome.  The rule places the top-level entity on the BIO side as a localized entity.",
...
?complex_record obo:BFO_0000051 ?this_react_xref_record .
