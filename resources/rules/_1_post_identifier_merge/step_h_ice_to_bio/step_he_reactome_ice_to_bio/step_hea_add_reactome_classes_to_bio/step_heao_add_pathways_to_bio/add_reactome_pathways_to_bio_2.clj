`{:description "This rule finds any pathway record described in Reactome with a GO BP annotation and puts it on the bio side.",
 :name "add_reactome_pathways_to_bio_2",
 :reify ([?/this_pw {:ln (:sha-1 ?/pw_record), :ns "http://ccp.ucdenver.edu/kabob/bio/", :prefix "BP_"}]
         ),
 :head
 ((?/react_ice obo/IAO_0000219 ?/this_pw) 
  (?/this_pw rdfs/subClassOf ?/go_bp)  ;; specific GO-BP
  ),
 :body "#add_reactome_pathways_to_bio_2.clj
