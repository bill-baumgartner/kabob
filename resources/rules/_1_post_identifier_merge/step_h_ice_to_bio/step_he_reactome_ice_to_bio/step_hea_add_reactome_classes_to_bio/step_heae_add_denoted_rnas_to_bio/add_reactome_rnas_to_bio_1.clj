`{:description "This rule finds any unmodified rna record described in Reactome.  The rule places the top-level entity on the BIO side as a localized subclass of the BIO entity denoted by the ENSEMBL or NCBI Nucleotide ICE id.",
 :name "add_reactome_rnas_to_bio_1",
 ...
 :body "#add_reactome_rnas_to_bio_1
...
SELECT DISTINCT ?reactome_ice ?external_bio ?accession_label ?transports_bio ?targets_bio ?localization_bio ?go_cc_bio ?rna_record ?external_bio
WHERE {
