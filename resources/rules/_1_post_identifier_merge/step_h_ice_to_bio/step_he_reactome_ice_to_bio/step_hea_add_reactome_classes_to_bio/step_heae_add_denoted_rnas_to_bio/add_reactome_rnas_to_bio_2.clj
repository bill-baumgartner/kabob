`{:description "This rule finds any modified rna record described in Reactome.  The rule places the top-level entity on the BIO side as a localized subclass of the BIO entity denoted by the ENSEMBL or NCBI Nucleotide ICE id.",
 :name "add_reactome_rnas_to_bio_2",
 ...
 :body "#add_reactome_rnas_to_bio_2
