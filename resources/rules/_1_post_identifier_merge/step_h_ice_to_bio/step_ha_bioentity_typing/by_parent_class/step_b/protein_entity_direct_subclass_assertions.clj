...
;; -------------------------------------------------------------
`{:name "step-ha-b_protein-entity-direct-subclass-assertions"
  ...
  :head ((?/protein_scsc rdfs/subClassOf ?/protein))
  :body "prefix obo: <http://purl.obolibrary.org/obo/>
         prefix kice: <http://ccp.ucdenver.edu/kabob/ice/>
         PREFIX obo_pr: <http://purl.obolibrary.org/obo/pr#>
         PREFIX franzOption_chunkProcessingAllowed: <franz:yes>
         PREFIX franzOption_clauseReorderer: <franz:identity>
         select ?protein_scsc ?protein_sc ?protein {
            ?protein rdf:type kice:temp_protein_root .
            ?protein_sc rdfs:subClassOf ?protein .
            ?protein_scsc rdfs:subClassOf* ?protein_sc .
         }"
  }