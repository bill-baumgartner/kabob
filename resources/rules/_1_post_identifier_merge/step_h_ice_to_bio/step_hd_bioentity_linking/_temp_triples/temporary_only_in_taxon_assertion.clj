...
;; -------------------------------------------------------------
`{:name "step-hd_0_temp-only-in-taxon-assertion"
  :description "This rule temporarily marks the only_in_taxon property so that it can be easily referenced in downstream rules."
